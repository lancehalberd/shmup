...
allWorlds[WORLD_FOREST_LOWER] = {
    ...
    events: {
        ...
        explodingBeetle: explodingBeetle('shield'),
...
const {
    createEnemy, addEnemyToState, enemyData, updateEnemy, spawnEnemy,
    ENEMY_SHIELD_MONK,
} = require('enemies');
