const WORLD_STARS_BOSS = 'starsBoss';
const CHECK_POINT_STARS_BOSS = 'starsBoss';

module.exports = {
    CHECK_POINT_STARS_BOSS
};
...
allWorlds[WORLD_STARS_BOSS] = { advanceWorld };
checkpoints[CHECK_POINT_STARS_BOSS] = function (state) {
    const world = getStarWorld(WORLD_STARS_BOSS);
    world.nextX = world.x + 1000;
    world.returnPoint = CHECK_POINT_STARS_BOSS;
